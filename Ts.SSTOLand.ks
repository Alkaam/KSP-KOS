...
SET RUNMODE TO 2.
IF ALTITUDE > 15000 {SET RUNMODE TO 1.}
WHEN ALT:RADAR < 25000 THEN {RCS OFF. PRINT "RCS OFF" AT (0,4).}

set dTIME to TIME:SECONDS.
set tVERTICALSPEED to 1.1. set eVERTICALSPEED to 0. set iVERTICALSPEED to -40.
set pVAL to 0. set tVAL to 0. set rVAL to 0.
set tROLL to 0. set eROLL to 0. set iROLL to 0. set dROLL to 0.
set SHIPROLLMULTIPLIER to 1.75.

set tHeading to 0. set prevHEADINGSLIST TO LIST().
set var to 0.
until var > 20{ SET prevHEADINGSLIST:ADD TO 0. set var to var + 1. }

set var to 0. set avgHEADING to 0. set tALTITUDE to 0. set maxBANK to 50. // The max bank angle set maxVERTICALSPEED to 100.
